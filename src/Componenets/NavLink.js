    ...
    return (
       <>
        ...
        <Link style={currentTab(history, "/Contact")} className="p-4 "  to="/Contact">Contact</Link>
            ...
            {!isAuthenticated()&&(
                <>
                 <Link style={currentTab(history, "/Signup")} className="p-4 "  to="/Signup">Signup</Link>
                 <Link style={currentTab(history, "/Login")} className="p-4 "  to="/Login">Login</Link>
                </>
            )} 

            {
              isAuthenticated()&&(
                <span  type="button" className="text-yellow-400 p-4" onClick={logOut} >
                  Logout
                  </span>
              )
            }   
